...
<body>
    ...
    <div class="auth-card">
        ...
        <form action="<?php echo e(route('student.signup.post')); ?>" method="POST">
            <?php echo csrf_field(); ?>

            <div class="form-group">
                <label for="name">Nom complet *</label>
                <input type="text" id="name" name="name" class="form-control" value="<?php echo e(old('name')); ?>" required placeholder="ex: Jean Dupont">
            </div>

            <div class="form-group">
                <label for="email">Adresse email *</label>
                <input type="email" id="email" name="email" class="form-control" value="<?php echo e(old('email')); ?>" required placeholder="ex: jean.dupont@email.com">
            </div>

            <div class="form-group">
                <label for="phone">Numéro de téléphone *</label>
                <input type="tel" id="phone" name="phone" class="form-control" value="<?php echo e(old('phone')); ?>" required placeholder="ex: +225 07080910">
            </div>
        ...
        <div class="auth-footer">
            Vous avez déjà un compte ? <a href="<?php echo e(route('student.login')); ?>">Connectez-vous</a>
        </div>
    </div>

</body>
</html>
<?php /**PATH C:\xampp\htdocs\formation\resources\views/auth/signup.blade.php ENDPATH**/ ?>