        ...
        <aside class="admin-sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <a href="<?php echo e(route('admin.trainings')); ?>"
                   class="sidebar-link <?php echo e(request()->routeIs('admin.trainings*') ? 'active' : ''); ?>">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                ...
                <a href="<?php echo e(route('admin.bundles')); ?>"
                   class="sidebar-link <?php echo e(request()->routeIs('admin.bundles*') ? 'active' : ''); ?>">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <main class="admin-main">
            <div class="admin-topbar">
                ...
                <div class="topbar-right">
                    ...
                    <!-- Visit Site -->
                    <a href="<?php echo e(url('/')); ?>" target="_blank" class="topbar-visit-btn">
...
<?php /**PATH C:\xampp\htdocs\formation\resources\views/admin/layout.blade.php ENDPATH**/ ?>