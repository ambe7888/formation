<?php $__env->startSection('title', 'Créer un Pack / Bundle'); ?>

<?php $__env->startSection('content'); ?>
<div class="card card-borderless p-4">
    <?php if($trainings->count() < 2): ?>
        <div class="alert alert-warning">
            Vous devez disposer d'au moins 2 formations actives pour créer un pack.
            <a href="<?php echo e(route('admin.trainings.create')); ?>" style="color:inherit;font-weight:600;">Ajouter une formation active</a>.
        </div>
    <?php endif; ?>

    <form action="<?php echo e(route('admin.bundles.store')); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        ...
        <div style="display:grid;grid-template-columns:1fr auto;gap:1.25rem;align-items:start;margin-bottom:1.25rem;">
            <div>
                ...
                <input type="text" class="form-control" id="name" name="name"
                       value="<?php echo e(old('name')); ?>" placeholder="ex : Pack Complet IA & Marketing" required>
            </div>
            <div style="min-width:180px;">
                <label for="price" class="form-label">Prix Spécial Bundle (CFA) *</label>
                <input type="number" class="form-control" id="price" name="price"
                       value="<?php echo e(old('price')); ?>" placeholder="ex : 25000" min="0" required>
            </div>
        </div>
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control" id="description" name="description" rows="3"
                       placeholder="Présentez les avantages de ce pack groupé..."><?php echo e(old('description')); ?></textarea>
        </div>
            ...
            <div style="display:flex;align-items:center;gap:2rem;flex-wrap:wrap;">
                ...
                <div>
                    ...
                    <input type="number" class="form-control" id="hero_order" name="hero_order"
                           value="<?php echo e(old('hero_order', 0)); ?>" min="0" style="width:130px;">
                </div>
            </div>
                ...
                <?php $__currentLoopData = $trainings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $training): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <label for="training_<?php echo e($training->id); ?>"
                        ...
                        <input class="form-check-input" type="checkbox"
                               ...
                               <?php echo e(is_array(old('trainings')) && in_array($training->id, old('trainings')) ? 'checked' : ''); ?>>
                        <span>
        ...
        <div style="display:flex;gap:0.75rem;margin-top:1.5rem;">
            <button type="submit" class="btn btn-primary" <?php echo e($trainings->count() < 2 ? 'disabled' : ''); ?>>
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\formation\resources\views/admin/bundles/create.blade.php ENDPATH**/ ?>