...
<head>
    ...
    <title><?php echo e($formattedTraining['name']); ?> - Success Business Training</title>
    <meta name="description" content="<?php echo e(Str::limit($formattedTraining['description'], 160)); ?>">
        ...
        <article>
            <div class="details-card">
                ...
                <div class="description-text">
                    <?php echo e($formattedTraining['description']); ?>
                ...
                <div class="skills-grid">
                    <?php $__empty_1 = true; $__currentLoopData = $formattedTraining['skills']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $skill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            ...
            <div class="pricing-card">
                ...
                <ul class="meta-list">
                    <li class="meta-item">
                        ...
                        <span><?php echo e($formattedTraining['location']); ?></span>
                    </li>
                    <li class="meta-item">
                        <span class="meta-icon">📅</span>
                        <span class="meta-label">Date de début</span>
                        <span><?php echo e($formattedTraining['date']); ?></span>
                    </li>
                    <li class="meta-item">
                        <span class="meta-icon">👥</span>
                        <span class="meta-label">Places disponibles</span>
                        <span style="color: <?php echo e($formattedTraining['available'] > 3 ? '#059669' : '#d97706'); ?>;">
                            <?php echo e($formattedTraining['available']); ?> places
                        </span>
                    </li>
                </ul>
                ...
                <?php if(request('status') === 'success'): ?>
                    <div class="thank-you-card" style="text-align: center; padding: 2rem; background: #ffffff; border-radius: 1.5rem; border: 2px solid #10b981; box-shadow: 0 20px 40px rgba(16, 185, 129, 0.08); width: 100%; box-sizing: border-box;">
                        ...
                        <p style="font-size: 0.95rem; line-height: 1.5; color: var(--text-main); margin-bottom: 1.5rem;">
                            Votre demande pour <strong><?php echo e(request('course')); ?></strong> a bien été enregistrée.
                        </p>
                ...
                <?php else: ?>
                    ...
                    <form action="<?php echo e(route('register')); ?>" method="POST" id="main_registration_form">
                        ...
                        <input type="hidden" name="redirect_to" value="<?php echo e(route('training.show', $training->id)); ?>">
                        <!-- Preselected course -->
                        ...
                        <div class="form-group-custom">
                            ...
                            <input type="text" class="form-control-custom" value="<?php echo e($formattedTraining['name']); ?>" id="selected_course_label" disabled style="font-weight: 700; background-color: #f1f5f9;">
                        </div>
...
<?php /**PATH C:\xampp\htdocs\formation\resources\views/training_details.blade.php ENDPATH**/ ?>