<?php $__env->startSection('title', 'Modifier le Pack / Bundle'); ?>

<?php $__env->startSection('content'); ?>
<div class="card card-borderless p-4">
    <form action="<?php echo e(route('admin.bundles.update', $bundle)); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        ...
        <div style="display:grid;grid-template-columns:1fr auto;gap:1.25rem;align-items:start;margin-bottom:1.25rem;">
            ...
            <div style="min-width:180px;">
                ...
                <input type="number" class="form-control" id="price" name="price"
                       value="<?php echo e(old('price', $bundle->price)); ?>" min="0" required>
            </div>
        </div>

        <div class="mb-3">
            <label for="description" class="form-label">Description du Pack</label>
            <textarea class="form-control" id="description" name="description" rows="3"><?php echo e(old('description', $bundle->description)); ?></textarea>
        </div>
        ...
        <div class="mb-3">
            ...
            <?php if($bundle->image_url): ?>
                <small class="text-muted d-block mt-1">Image actuelle : <?php echo e($bundle->image_url); ?></small>
            <?php endif; ?>
            ...
            <div style="display:flex;align-items:center;gap:2rem;flex-wrap:wrap;">
                <div style="display:flex;align-items:center;gap:0.75rem;">
                    <label for="is_featured" style="display:flex;align-items:center;gap:0.6rem;cursor:pointer;">
                        <?php $isFeatured = old('is_featured') !== null ? old('is_featured') : $bundle->is_featured; ?>
                        <input type="checkbox" id="is_featured" name="is_featured" value="1"
                               <?php echo e($isFeatured ? 'checked' : ''); ?>

                               style="width:38px;height:20px;appearance:none;background:<?php echo e($isFeatured ? '#6366F1' : 'var(--bg-hover)'); ?>;border:1px solid var(--border);border-radius:999px;cursor:pointer;position:relative;transition:background 200ms;flex-shrink:0;"
                ...
                <div>
                    ...
                    <input type="number" class="form-control" id="hero_order" name="hero_order"
                           value="<?php echo e(old('hero_order', $bundle->hero_order ?? 0)); ?>" min="0" style="width:130px;">
                </div>
            </div>
        ...
        <div class="mb-3">
            ...
            <div style="background:var(--bg-surface);border:1px solid var(--border);border-radius:10px;max-height:240px;overflow-y:auto;padding:0.75rem 1rem;">
                <?php $__currentLoopData = $trainings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $training): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <label for="training_<?php echo e($training->id); ?>"
                        ...
                        <input class="form-check-input" type="checkbox"
                               name="trainings[]" id="training_<?php echo e($training->id); ?>"
                               value="<?php echo e($training->id); ?>"
                               <?php echo e((is_array(old('trainings')) ? in_array($training->id, old('trainings')) : $bundle->trainings->contains($training->id)) ? 'checked' : ''); ?>>
                        <span>
                            <strong style="color:var(--text-1);font-size:0.875rem;"><?php echo e($training->title); ?></strong>
                            <span style="color:var(--text-3);font-size:0.78rem;margin-left:0.5rem;"><?php echo e(number_format($training->price, 0, ',', ' ')); ?> CFA</span>
                        </span>
                    </label>
        ...
        <div style="display:flex;gap:0.75rem;margin-top:1.5rem;">
            ...
            <a href="<?php echo e(route('admin.bundles')); ?>" class="btn btn-outline">Annuler</a>
        </div>
    </form>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\formation\resources\views/admin/bundles/edit.blade.php ENDPATH**/ ?>