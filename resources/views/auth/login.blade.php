...
<head>
    ...
    <title>Connexion Espace Étudiant - Success Business Training</title>
    ...
    <link rel="stylesheet" href="{{ asset('assets/style.css') }}?v=1.0.2">    <style>
        body {
...
<body>
    ...
    <div class="auth-card">
        ...
        <h1 class="auth-title">Connexion Étudiant</h1>
        <p class="auth-subtitle">Accédez à vos inscriptions et au suivi de vos paiements partiels.</p>
        ...
        <form action="{{ route('student.login.post') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="email" id="email" name="email" class="form-control" value="{{ old('email') }}" required placeholder="votre.email@exemple.com">
            </div>

            <div class="form-group">
                <label for="password">Mot de passe *</label>
                <div style="position: relative; display: flex; align-items: center;">
                    <input type="password" id="password" name="password" class="form-control" required placeholder="Votre mot de passe" style="padding-right: 3rem;">
                    <button type="button" id="togglePassword" style="position: absolute; right: 1rem; background: none; border: none; cursor: pointer; color: var(--muted); display: flex; align-items: center; justify-content: center; padding: 0;">
                        ...
                        <svg id="eyeHide" style="display: none;" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"></path><line x1="1" y1="1" x2="23" y2="23"></line></svg>
                    </button>
                </div>
            </div>
            ...
            <div class="remember-row">
                <label class="remember-checkbox">
                    <input type="checkbox" name="remember" style="accent-color: var(--brand);"> Se souvenir de moi
                </label>
            </div>

            <button type="submit" class="btn-auth">Me connecter</button>
        </form>

        <div class="auth-footer">
            Vous n'avez pas encore de compte ? <a href="{{ route('student.signup') }}">Inscrivez-vous</a>
        </div>
    </div>
